...
public class Board extends JPanel implements KeyListener, MouseListener, MouseMotionListener
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        if (gamePaused)
        {
            ...
            g.drawString(gamePausedString, 35, StartGameWindow.HEIGHT / 2);
        }
        ...
        g.drawString("SCORE", StartGameWindow.WIDTH - 125, StartGameWindow.HEIGHT / 2);
        g.drawString(score + "", StartGameWindow.WIDTH - 125, StartGameWindow.HEIGHT / 2 + 30);
